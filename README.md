...
## Project Structure
    ...
    ├── testtemplateweb_dev_25074  # Django project configurations
...
1. Clone this repo and `cd testtemplateweb_dev_25074`
...
2. Clone this repo and `cd testtemplateweb_dev_25074`
